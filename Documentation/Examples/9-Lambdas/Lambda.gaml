...
*/
func void foo(const MyLambdaSignature InL) 
{
    InL(5, 4);
}
...
*/
func lambda (bool, int32) => void bar(lambda (int32, int32) => lambda (bool, int32) => void InL)
{
    return InL(5, 4)
}
...
func LambdaOut Goobar(LambdaIn InL)
{
    return InL(5, 4)
}
