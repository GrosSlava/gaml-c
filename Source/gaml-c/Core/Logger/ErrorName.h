...
public:
	...
	inline FErrorInfo() { }
	inline FErrorInfo(EErrorType InErrorType, EWarningLevel InWarningLevel, const std::string& InMessage) :
		ErrorType(InErrorType), WarningLevel(InWarningLevel), Message(InMessage)
	{
	}
