...
void FLexer::Split(const std::string& Code, std::vector<Token>& OutTokens)
{
...
void FLexer::Merge(std::vector<Token>& OutTokens)
{
...
void FLexer::PushCurrentLexeme(std::vector<Token>& OutTokens, size_t PosBack)
{
